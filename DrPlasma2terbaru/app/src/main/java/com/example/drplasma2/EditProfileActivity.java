...
public class EditProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Mengambil Data Pengguna dan Memperbarui UI
    ...
    private void updateUserDataToFirebase() {
        ...
        if (currentUserId != null && !currentUserId.isEmpty()) {
            ...
            //Memperbarui data pengguna di Firebase dengan nilai-nilai baru.
            ...
            //Memperbarui URL foto profil jika ada perubahan gambar profil
    ...
    //Membuat salinan bitmap dari gambar di ImageView
